...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    IMiniDouyinService iMiniDouyinService;
    ...
    private void postVideo() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        iMiniDouyinService = retrofit.create(IMiniDouyinService.class);
        Call<PostVideoResponse> call = iMiniDouyinService.createVideo("harpoon","ywz",file1,file2);
        call.enqueue(new Callback<PostVideoResponse>() {
            @Override
            public void onResponse(Call<PostVideoResponse> call, Response<PostVideoResponse> response) {
                if(response.body().getSuccess()){
                    Toast toast = Toast.makeText(getApplicationContext(),"成功咯",Toast.LENGTH_SHORT);
                    toast.show();
                    mBtn.setText(R.string.success_try_refresh);
                    mBtn.setEnabled(true);
                }
                else {
                    Toast toast = Toast.makeText(getApplicationContext(),"失败了嘤嘤嘤1",Toast.LENGTH_SHORT);
                    toast.show();
                    mBtn.setText(R.string.select_an_image);
                    mBtn.setEnabled(true);
                }
            ...
            public void onFailure(Call<PostVideoResponse> call, Throwable t) {
                Toast toast = Toast.makeText(getApplicationContext(),"失败了嘤嘤嘤2",Toast.LENGTH_SHORT);
                toast.show();
                mBtn.setText(R.string.select_an_image);
                mBtn.setEnabled(true);
    ...
    public void fetchFeed(View view) {
        ...
        call.enqueue(new Callback<FeedResponse>() {
            ...
            public void onResponse(Call<FeedResponse> call, Response<FeedResponse> response) {
                if(response.body().getSuccess()){
                    Toast toast = Toast.makeText(getApplicationContext(), "获取成功咯", Toast.LENGTH_SHORT);
                    toast.show();
